...
time.sleep(2)
def case_2_3_5(self, full_screen):
    self.page.loger('\n Запуск Тест кейс № 2_3_5 tvweb_new-2_3_5: Проверка фильтров поиска на странице Новинки(Аудио)')

    time.sleep(1)
    self.page.click_f('Клик_Новинки', 29)
    time.sleep(2)
    ...
    self.page.loger_info('Название фильма до применения фильтра аудио Английский: ' + rec_sic.text)
    time.sleep(2)
    ...
    time.sleep(1)
    self.driver.find_element_by_xpath('.//li[@data-filter-id="52485"]').click() # Клик Китайский
    time.sleep(1)
