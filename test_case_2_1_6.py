...
time.sleep(2)
def case_2_1_6(self, full_screen):
    self.page.loger('\n Запуск Тест кейс № 2_1_6 tvweb_new-2_1_6: Проверка фильтров поиска на странице Каталог(Субтитры)')
    ...
    time.sleep(3)    
    self.page.click_f('Клик_применить_фильтр', 2)
    time.sleep(2)
