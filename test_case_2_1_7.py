...
time.sleep(2)
def case_2_1_7(self, full_screen):
    self.page.loger('\n Запуск Тест кейс № 2_1_7 tvweb_new-2_1_7: Проверка фильтров поиска на странице Каталог(Родительский контроль)')

    time.sleep(1)
    self.page.click_f('Клик_Каталог', 33)
    time.sleep(3)
