...
time.sleep(2)
def case_2_2_8(self, full_screen):
    self.page.loger('\n Запуск Тест кейс № 2_2_8 tvweb_new-2_2_8: Проверка фильтров поиска на странице Бесплатно(Бесплатно)')
   
    time.sleep(1)
    self.page.click_f('Клик_Бесплатно', 35)
    time.sleep(4)
