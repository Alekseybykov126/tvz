...
time.sleep(2)
def case_2_2_7(self, full_screen):
    self.page.loger('\n Запуск Тест кейс № 2_2_7 tvweb_new-2_2_7: Проверка фильтров поиска на странице Бесплатно(Родительский контроль)')
    
    time.sleep(1)
    self.page.click_f('Клик_Бесплатно', 33)
    time.sleep(3)
