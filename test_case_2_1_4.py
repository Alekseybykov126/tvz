...
time.sleep(2)
def case_2_1_4(self, full_screen):
    self.page.loger('\n Запуск Тест кейс № 2_1_4 tvweb_new-2_1_4: Проверка фильтров поиска на странице Каталог(Года, Жанры, Страны)')

    time.sleep(1)
    self.page.click_f('Клик_Каталог', 17)
    time.sleep(3)
    ...
    pyautogui.dragTo(1454, 599, 2, button='left') #конечные координаты
    time.sleep(2)
    ...
    time.sleep(1)
    self.page.click_f('Клик_азиатский_жанр', 22)
    time.sleep(2)
    ...
    time.sleep(1)
    self.page.click_f('Клик_Япония', 25)
    time.sleep(2)
    ...
    assert ('Япония') in resic  # проверочное словосочетание надписи
    self.page.loger_info('Наличие страны "Япония" в карточке фильма подтверждено')
    time.sleep(2)
    ...
    assert ('Азиатский') in resic  # проверочное словосочетание надписи
    self.page.loger_info('Наличие жанра "Азиатский" в карточке фильма подтверждено')
    time.sleep(1)
