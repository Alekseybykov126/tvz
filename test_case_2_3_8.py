...
time.sleep(2)
def case_2_3_8(self, full_screen):
    self.page.loger('\n Запуск Тест кейс № 2_3_8 tvweb_new-2_3_8: Проверка фильтров поиска на странице Новинки(Бесплатно)')

    time.sleep(1)
    self.page.click_f('Клик_Новинки', 35)
    time.sleep(4)
